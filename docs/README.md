...
Project docs live in this folder. Start here, then follow links by topic.
...
| [Domain logic](./domain-logic.md) | Search, suggestions, pantry expiry/opened rules, normalization, parsing |
